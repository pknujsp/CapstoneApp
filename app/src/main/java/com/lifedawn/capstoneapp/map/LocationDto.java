...
public class LocationDto implements Serializable {
    ...
    public String toString() {
        ...
        stringBuilder.append(latitude).append(",").append(longitude).append(",").append(placeName == null ? "" :
                placeName).append(",").append(placeId).append(",").append(addressName);
    ...
    public static LocationDto toLocationDto(String str) {
        ...
        locationDto.setLatitude(separatedStr[0]).setLongitude(separatedStr[1])
                .setPlaceName(separatedStr[2]).setPlaceId(separatedStr[3])
                .setAddressName(separatedStr[4])
                .setLocationType(locationDto.getPlaceName() == null ? Constant.ADDRESS : Constant.PLACE);
        return locationDto;
