...
public class AddPromiseFragment extends AbstractPromiseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setAccount(accountCalendarViewModel.getUsingAccountType(), accountCalendarViewModel.getConnectedGoogleAccount());
        ...
        binding.saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //캘린더ID 지정
                googleAccountLifeCycleObserver.setInstanceUserRecoverableAuthIntentActivityResultCallback(new ActivityResultCallback<ActivityResult>() {
                    @Override
                    public void onActivityResult(ActivityResult result) {
                        calendarService = googleCalendarUtil.getCalendarService(GoogleAccountUtil.getInstance(getContext())
    ...
    protected void onClickedMap() {
        if (locationDto != null) {
            String message = locationDto.getLocationType() == Constant.ADDRESS ? locationDto.getAddressName() :
                    locationDto.getPlaceName() + getString(R.string.message_change_location);

            AlertDialog dialog = new MaterialAlertDialogBuilder(getActivity())
                    .setTitle(R.string.title_asking_to_change_location)
