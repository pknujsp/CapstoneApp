...
public abstract class AbstractPromiseFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        googleAccountLifeCycleObserver = new GoogleAccountLifeCycleObserver(requireActivity().getActivityResultRegistry(), requireActivity());
    ...
    protected void showMap(LocationItemViewPagerAbstractAdapter.OnClickedLocationBtnListener onClickedLocationBtnListener){
        ...
        getParentFragmentManager().beginTransaction().hide(this).add(R.id.fragmentContainerView,
    ...
    protected void onSelectedLocation(LocationDto locationDto){
        binding.placeName.setText(locationDto.getLocationType() == Constant.PLACE ?
                locationDto.getPlaceName(): locationDto.getAddressName());
    }
