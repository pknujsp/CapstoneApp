	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		binding.notificationDefaultSettings.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				getParentFragmentManager().beginTransaction().hide(AppSettingsFragment.this).add(R.id.fragmentContainerView,
						defaultNotificationSettingsFragment, DefaultNotificationSettingsFragment.class.getName()).addToBackStack(
