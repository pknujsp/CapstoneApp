...
public class GoogleCalendarUtil {
                        ...
                        new ActivityResultCallback<ActivityResult>() {
                            ...
                            public void onActivityResult(ActivityResult result) {
                                if (result.getResultCode() == Activity.RESULT_OK) {
                                    ...
                                    Toast.makeText(googleAccountCredential.getContext(), R.string.denied_access_to_calendar, Toast.LENGTH_SHORT).show();
                                }
    ...
    public void addPromiseCalendar(Calendar calendarService, OnHttpApiCallback<com.google.api.services.calendar.model.Calendar> callback) {
        ...
        newCalendar.setSummary(MAIN_CALENDAR_SUMMARY).setTimeZone(TimeZone.getDefault().getDisplayName(Locale.US));
